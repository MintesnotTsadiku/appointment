...
Run this via Frappe console:
    bench --site appointment.com console < frappe_appointment/scheduler/doctype/service/migrate_service_provider.py

Or execute directly:
    cd /home/minte/projects/frappe-bench && bench --site appointment.com console <<< "
    exec(open('apps/frappe_appointment/frappe_appointment/scheduler/doctype/service/migrate_service_provider.py').read())
    "
"""
