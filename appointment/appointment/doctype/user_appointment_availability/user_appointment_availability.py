...
from appointment.helpers.intervals import find_intersection_interval
from appointment.helpers.utils import (
...
class UserAppointmentAvailability(Document):
    ...
    def on_update(self):
        ...
        try:
            from appointment.scheduler.booking_url_manager import sync_booking_urls_for_user_availability
