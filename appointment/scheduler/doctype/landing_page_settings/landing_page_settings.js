    ...
    refresh(frm) {
        ...
        frm.add_custom_button(__('Populate All Defaults'), function() {
            frappe.confirm(
                ...
                function() {
                    frappe.call({
                        method: 'appointment.scheduler.doctype.landing_page_settings.landing_page_settings.populate_all_defaults',
                        freeze: true,
...
function show_color_preset_dialog(frm) {
    ...
    frappe.call({
        method: 'appointment.scheduler.doctype.landing_page_settings.landing_page_settings.get_color_presets',
        callback: function(r) {
            if (r.message) {
                ...
                let d = new frappe.ui.Dialog({
                    ...
                    primary_action(values) {
                        ...
                        frappe.call({
                            method: 'appointment.scheduler.doctype.landing_page_settings.landing_page_settings.apply_color_preset',
