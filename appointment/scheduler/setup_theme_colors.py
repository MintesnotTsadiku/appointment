...
Run via bench console or bench execute:
    ...
    bench --site [sitename] execute appointment.scheduler.setup_theme_colors.setup_default_colors

Or from bench console:
    
    from appointment.scheduler.setup_theme_colors import setup_default_colors
...
def reset_to_default_colors():
    ...
    Usage:
        bench --site [sitename] execute appointment.scheduler.setup_theme_colors.reset_to_default_colors
    """
...
def print_current_colors():
    ...
    Usage:
        bench --site [sitename] execute appointment.scheduler.setup_theme_colors.print_current_colors
    """
    try:
        settings = frappe.get_single("Landing Page Settings")
    except Exception:
