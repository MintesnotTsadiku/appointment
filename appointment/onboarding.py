    ...
    try:
        ...
        if provider.locations:
            ...
            if existing_location:
                ...
                from appointment.scheduler.availability import apply_default_hours
...
def create_appointment_group(
    ...
    try:
        ...
        # Sync booking URLs
        try:
            from appointment.scheduler.booking_url_manager import sync_booking_urls_for_appointment_group
