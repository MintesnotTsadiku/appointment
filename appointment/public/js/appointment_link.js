    ...
    frappe.ui.form.on(doctype, {
      refresh: function (frm) {
        if (doctype == "User Appointment Availability" && !frm.doc.__islocal) {
          ...
          frappe.call({
            method: "appointment.overrides.event_override.get_personal_meetings",
            args: {
              user: frm.doc.name,
              past_events: true,
            },
      ...
      view_appointment: function (frm) {
        frappe.call({
          method: "appointment.overrides.event_override.get_events_from_doc",
          args: {
            doctype: doctype,
            docname: frm.docname,
            past_events: true,
      ...
      copy_appointment_link: function (frm) {
        frappe.call({
          method: "appointment.api.personal_meet.get_schedular_link",
          args: {
            user: frm.doc.name,
          },
          callback: function (r) {
