...
def update_availability_status_for_appointment_group(appointment_group):
    ...
    frappe.enqueue(
        "appointment.tasks.verify_availability.get_availability_status_for_appointment_group",
        queue="long",
...
def verify_appointment_group_members_availabililty():
    skip_availability_cron = frappe.conf.get("appointments", {}).get("skip_availability_cron", False)
