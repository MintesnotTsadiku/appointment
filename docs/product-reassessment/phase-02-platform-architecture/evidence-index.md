...
| F3 Ownership/accountability | META-01 fields and track_changes flags; existing model relationships | Safe backfill, audit completeness, export/import dependency closure and migration behavior |
