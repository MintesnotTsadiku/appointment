      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-heading font-extrabold text-white mb-6"
          >
            {t('finalCTA.headline')}
          </motion.h2>
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap justify-center items-center gap-6 text-white/80 text-sm"
          >
