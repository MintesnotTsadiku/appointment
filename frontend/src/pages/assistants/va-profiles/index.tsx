...
import { ChevronLeft, Plus, Search, Users, Loader2 } from 'lucide-react';
import { Button } from '@/components/button';
import { Card } from '@/components/card';
import { Input } from '@/components/input';
import { VAProfileCard } from '@/components/assistants/VAProfileCard';
...
const VAProfiles = () => {
  ...
  const filteredProfiles = vaProfiles.filter((profile) => {
    if (searchQuery) {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs lg:text-sm mt-1" style={{ color: 'var(--text-subtle)' }}>
                      Manage virtual assistant profiles
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <span className="relative z-10">Create VA Profile</span>
              </motion.button>
            </div>
            ...
            <div className="relative">
              ...
              <Input
                placeholder="Search VA profiles..."
                value={searchQuery}
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {loading ? (
            ...
            >
              ...
              <p className="text-lg font-semibold mb-2">No VA profiles found</p>
